...
const App = () => (
    <Admin layout={Layout} dashboard={Dashboard} authProvider={authProviderDjango} dataProvider={drfProvider('https://lighthouse-admin.apps.okd4.filice.eu/api', fetchJson)}>
